...
func NewClientTLSFromFile(certFile, serverNameOverride string) (TransportCredentials, error) {
	...
	if ok {
		return NewTLS(&tls.Config{ServerName: serverNameOverride, RootCAs: cp, GMUsed: true}), nil
	} else {
...
func NewServerTLSFromFile(certFile, keyFile string) (TransportCredentials, error) {
	...
	if ok {
		return NewTLS(&tls.Config{Certificates: []tls.Certificate{cert}, GMUsed: true}), nil
	} else {
